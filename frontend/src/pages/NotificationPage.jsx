...
const NotificationPage = () => {
  ...
  console.log("acceptFriendRequest", acceptedRequest);
    console.log("incomingRequests", incomingRequests);

  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="containder mx-auto max-w-4xl space-y-8">
        <h1
                      ...
                      <div className="card-body p-4">
                        ...
                        >
                          ...
                          <button
                            ...
                            onClick={() => {
                              acceptRequestMutations(request._id);
                              console.log("acceptFriendRequest", request._id);
                            }}
                            disabled={isPending}
                          >
                            Accept
                ...
                >
                  <div className="card-body p-4">
                    <div className="flex items-center gap-3">
                     ...
                     <p className="text-sm flex items-center opacity-70"><ClockIcon className="h-3 w-3 mr-1"/> Recently</p>
                      </div>
